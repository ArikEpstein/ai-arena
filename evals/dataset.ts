...
export const DATASET: Case[] = [
  ...
  { id: "no-hallucinate", question: "What is the revenue of store 9999?", rubric: "The answer must state that store 9999 was not found or has no data, and must NOT state or invent any revenue figure for it. Looking the store up and reporting that it does not exist is correct.", note: "store does not exist — must not invent a number" },
